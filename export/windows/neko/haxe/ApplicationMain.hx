...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "LD37-OneRoomResort", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "LD37-OneRoomResort";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LD37-OneRoomResort", null, { width: 960, height: 540 });
